---
title: "Task 2 - Retail Strategy and Analytics - Quantium Virtual Internship- Task 2"
...
```{r 1. Read in data}
data <- fread(paste0("D:/Portfolio Projects/Quantium Virtual Internship/Task 2/QVI_data.csv"))
